...
export const fmtTime = (iso: string | number | Date): string =>
  new Date(iso).toLocaleTimeString("en-CA", {
    timeZone: CONFIG.tz, hour: "2-digit", minute: "2-digit", hour12: false,
  });

export const fmtDay = (iso: string | number | Date): string =>
  new Date(iso).toLocaleDateString("en-CA", {
    timeZone: CONFIG.tz, weekday: "short",
  });
